...
$(DIVIDE_AND_CONQUER_OBJS_PREFIX)%.o: $(DIVIDE_AND_CONQUER_SRC_PREFIX)%.c $(DIVIDE_AND_CONQUER_SRC_PREFIX)%.h
	...
	$(CC) $(CFLAGS) -I$(MATRIX_SRC_PREFIX) -I$(UTILS_SRC_PREFIX) -I$(MATRIX_ALGO_SRC_PREFIX) -I$(SECULAR_EQUATION_SRC_PREFIX) -c $< -o $@
...
$(TEST_OBJS_PREFIX)%.o: $(TEST_SRC_PREFIX)%.c
	...
	$(CC) $(CFLAGS) -I$(MATRIX_SRC_PREFIX) -I$(UTILS_SRC_PREFIX) -I$(VALIDATION_SRC_PREFIX) -I$(DIVIDE_AND_CONQUER_SRC_PREFIX) -I$(MATRIX_ALGO_SRC_PREFIX) -I$(SECULAR_EQUATION_SRC_PREFIX) -c $< -o $@

$(BIN_PREFIX)test: $(TEST_OBJS) $(MATRIX_LIB) $(UTILS_LIB) $(VALIDATION_LIB)  $(DIVIDE_AND_CONQUER_LIB) $(SECULAR_EQUATION_LIB) $(MATRIX_ALGO_LIB)
	mkdir -p $(BIN_PREFIX)
	$(CC) $(CFLAGS) $^ -o $@ -lm
